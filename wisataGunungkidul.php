...
<head>
    ...
    <title>SinauBudaya-WisataGunungkidul</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s" >
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Lokasi</a>
                <div class="dropdown-menu m-0">
                    ...
                    <a href="wisataGunungkidul.php" class="dropdown-item active">Kabupaten Gunungkidul</a>
                </div>
                </div>
                <div class="nav-item dropdown">
    ...
    <div class="container-fluid bg-light my-5 py-5">
      <div class="container py-5">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 class="display-6 mb-5">Informasi Wisata Budaya Di Kabupaten Gunungkidul</h1>
        </div>
        <div class="row g-4 justify-content-center">

        <?php
        $result = mysqli_query($conn, "SELECT p.*, k.nama_kategori, r.nama_regional FROM pameran p JOIN kategori k ON p.id_kategori = k.id_kategori JOIN regional r ON p.id_regional = r.id_regional WHERE p.id_regional = 5 ORDER BY p.id_pameran DESC");
      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            <h1 class="fw-bold text-primary mb-4">Themis<span class="text-white">Team</span></h1>

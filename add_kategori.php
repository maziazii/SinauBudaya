  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Kategori Wisata</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                           ...
                           <div class="card-body">
                               <form role="form" method="POST" action="proses_add_kategori.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-10"> <input  required type="text" class="form-control" id="Nama" placeholder="Masukan Nama Kategori" name="nama_kategori"></div>
                                </div>

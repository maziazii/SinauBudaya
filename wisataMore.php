<?php
include "koneksi.php";
include "koneksiWisata.php";

if (isset($_GET['id'])) {
  $idWisata = $_GET['id'];

  $query = mysqli_query($conn, "SELECT p.*, k.nama_kategori, r.nama_regional FROM pameran p JOIN kategori k ON p.id_kategori = k.id_kategori JOIN regional r ON p.id_regional = r.id_regional WHERE p.id_pameran = $idWisata");
...
<head>
    ...
    <title>SinauBudaya-WisataSelengkapnya</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s" >
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
              ...
              <a href="wisata.php" class="nav-item nav-link active">Wisata</a>
    ...
    <div class="container-fluid bg-light my-5 py-5">
      <div class="container py-5">
        <!-- <div class="row g-4 justify-content-center"> -->
          <div class="col-xl-12 col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item bg-white text-center causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
              <div class="text-center pt-0">
                <div class="d-inline-block bg-primary text-white rounded-bottom fs-5 pb-1 px-3 mb-4">
                  ...
                  <div class="position-relative mt-auto">
                    ...
                    <?php
                      echo nl2br ($row['deskripsi_pameran'])
                    ?>
                <p>     </p>

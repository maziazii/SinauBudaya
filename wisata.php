...
<head>
    ...
    <title>SinauBudaya-Wisata</title>
...
<body>
    ...
    <div class="container-fluid bg-light my-5 py-5">
      <div class="container py-5">
        ...
        <?php
        $result = mysqli_query($conn, "SELECT p.*, k.nama_kategori, r.nama_regional FROM pameran p JOIN kategori k ON p.id_kategori = k.id_kategori JOIN regional r ON p.id_regional = r.id_regional ORDER BY p.id_pameran DESC");

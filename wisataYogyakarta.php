...
<head>
    ...
    <title>SinauBudaya-WisataYogyakarta</title>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="dropdown-menu m-0">
                    ...
                    <a href="wisataYogyakarta.php" class="dropdown-item active">Kota Yogyakarta</a>
    ...
    <div class="container-fluid bg-light my-5 py-5">
      <div class="container py-5">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 class="display-6 mb-5">Informasi Wisata Budaya Di Kota Yogyakarta</h1>
        </div>
        <div class="row g-4 justify-content-center">

        <?php
        $result = mysqli_query($conn, "SELECT p.*, k.nama_kategori, r.nama_regional FROM pameran p JOIN kategori k ON p.id_kategori = k.id_kategori JOIN regional r ON p.id_regional = r.id_regional WHERE p.id_regional = 2 ORDER BY p.id_pameran DESC");

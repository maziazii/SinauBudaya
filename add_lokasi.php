        ...
        <div class="row">
          <div class="col-md-12">
                         <div class="card">
                           ...
                           <div class="card-body">
                               <form role="form" method="POST" action="proses_add_lokasi.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                  <div class="col-sm-2 col-form-label"><label for="exampleInputLokasi">Lokasi</label></div>
                                  <div class="col-sm-10"> <input  required type="text" class="form-control" id="Lokasi" placeholder="Masukan Lokasi Wisata" name="nama_regional"></div>
                                </div>

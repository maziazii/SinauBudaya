        ...
        <div class="row">
          ...
          <div class="col-md-12">
                         <div class="card">
                           ...
                           <div class="card-body">
                               <form role="form" method="POST" action="proses_add_artikel.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                  <div class="col-sm-2 col-form-label"><label for="exampleInputJudul">Judul</label></div>
                                  <div class="col-sm-10"> <input  required type="text" class="form-control" id="Judul" placeholder="Masukan Judul Artikel" name="judul_artikel"></div>
                                </div>
                                  <div class="form-group row">
                                  <div class="col-sm-2 col-form-label"><label for="exampleInputDeskripsi">Deskripsi</label></div><div class="col-sm-10"> <textarea required class="form-control" id="Deskrisi" placeholder="Masukan Isi Artikel" name="deskripsi_artikel"></textarea></div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                  <div class="col-sm-2 col-form-label"><label for="exampleInputArtikel">Penulis</label></div><div class="col-sm-10"> <input  required type="text" class="form-control" id="Penulis" placeholder="Masukan Nama Penulis" name="penulis_artikel"></div>
                                </div>

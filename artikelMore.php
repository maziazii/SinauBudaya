...
if (isset($_GET['id'])) {
  ...
  $query = mysqli_query($conn, "SELECT a.* FROM `artikel` a WHERE a.id_artikel = $idArtikel");
...
<head>
    ...
    <title>SinauBudaya-ArtikelSelengkapnya</title>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item bg-white text-center h-100 p-4 p-xl-5">
              ...
              <p class="mb-4" style="text-align: left;">
                <?php
                  echo nl2br($row['deskripsi_artikel']);
                ?>
              </p>
            </div>
          </div>
